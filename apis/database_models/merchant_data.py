...
class merchant_data(models.Model):
    ...
    website_app_url = models.CharField(max_length=255, null=True)
    is_website_url = models.BooleanField(null=True)
    ...
    status = models.CharField(max_length=50, null=True, default=MerchantStatusCode.NOT_FILLED.value)
    ...
    avg_ticket_size = models.IntegerField(null=True)
    ...
    sourcing_point = models.CharField(max_length=250, null=True)
    sourcing_code = models.CharField(max_length=250, null=True)
    refer_by = models.ForeignKey("login_master", on_delete=models.CASCADE, null=True,
                                 db_column="refer_by")
